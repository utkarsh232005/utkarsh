        ...
        <div className="max-w-sm sm:max-w-sm md:max-w-sm bg-gray-900 border border-neutral-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            {title === 'Snap Shot' && (
                <a href={git} target="_blank" rel="noopener noreferrer">
                    <img className="w-full rounded-t-lg h-auto object-cover" src={vpn} alt={title} />
                </a>
            )}
            {title === 'Co People' && (
                <a href={git} target="_blank" rel="noopener noreferrer">
                    <img className="w-full rounded-t-lg h-auto object-cover" src={copeople} alt={title} />
                </a>
            )}
...
export const project = [
    {
        ...
        image: copeople,
        git: 'https://github.com/yourusername/copeople',
    ...
    },
    {
        ...
        image: vpn,
        git: 'https://github.com/yourusername/snapshot',
